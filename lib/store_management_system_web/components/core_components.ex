defmodule StoreManagementSystemWeb.CoreComponents do
  @moduledoc """
  ...
  import StoreManagementSystemWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoreManagementSystemWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoreManagementSystemWeb.Gettext, "errors", msg, opts)
    end
  end
